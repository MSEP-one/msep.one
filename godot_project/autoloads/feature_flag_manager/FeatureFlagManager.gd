...
const FEATURE_FLAG_EMITTERS_WITH_EMMIT_COUNT = &"feature_flags/particle_emitters_with_emmit_count"
const FEATURE_FLAG_EMITTERS_SHOW_UNSPAWNED_INSTANES = &"feature_flags/particle_emitters_show_unspawned_instanes"
