...
func _init(in_workspace_context: WorkspaceContext, in_menu: NanoRingMenu) -> void:
	...
	add_action(preload("ring_action_toggle_dna_representation.gd").new(in_workspace_context, in_menu))
	add_action(preload("ring_action_toggle_nanotube_representation.gd").new(in_workspace_context, in_menu))
