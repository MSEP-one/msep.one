...
func _init(in_workspace_context: WorkspaceContext, in_menu: NanoRingMenu) -> void:
	...
	super._init(
		tr("Enhanced Sticks"),
		_execute_action,
		tr("Draw bonds as sticks in a more physically accurate way")
	)
	with_validation(_can_activate)


func get_icon() -> RingMenuIcon:
	return RingMenuSpriteIconScn.instantiate().init(preload("res://editor/controls/menu_bar/menu_view/icons/icon_representation_enhanced_sticks.svg"))


func _can_activate() -> bool:
	if _workspace_context == null:
		return false
	return _workspace_context.workspace.representation_settings.get_rendering_representation() != \
...
func _execute_action() -> void:
	...
	_workspace_context.snapshot_moment("Representation change to Enhanced Sticks")
