...
func _init(in_workspace_context: WorkspaceContext, in_menu: NanoRingMenu) -> void:
	...
	_ring_menu = in_menu
	super._init(
		tr("Mechanical Simulation"),
		_execute_action,
		tr("Draw atoms as mechanically interactible solid objects, invisible bonds")
	)
...
func _can_activate() -> bool:
	...
	return representation_settings.get_rendering_representation() != Rendering.Representation.MECHANICAL_SIMULATION
