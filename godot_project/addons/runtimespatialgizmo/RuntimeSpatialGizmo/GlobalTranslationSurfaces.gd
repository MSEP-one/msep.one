...
func gather_colliding_surfaces() -> void:
	...
	prepare_surface_points(Vector3.RIGHT, Vector3.UP, 0)
	prepare_surface_points(-Vector3.FORWARD, Vector3.UP, 1)
	prepare_surface_points(Vector3.RIGHT, -Vector3.FORWARD, 2)
...
func calculate_plane(vec_dir) -> void:
	var plane_normal: Vector3 = vec_dir
